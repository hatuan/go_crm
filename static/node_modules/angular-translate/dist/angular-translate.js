...
function $translate($STORAGE_KEY, $windowProvider, $translateSanitizationProvider, pascalprechtTranslateOverrider) {
 ...
 /**
   ...
   * settings the indicator as 'X' and one tries to translate a translation id
 ...
 /**
  ...
  this.$get = [
    ...
    function ($log, $injector, $rootScope, $q) {
       ...
       *
       * @description
       * Makes actual use of a language by settings a given language key as used
      ...
      if ($interpolatorFactories.length) {
        var eachInterpolationFactory = function (interpolatorFactory) {
          ...
          // settings initial locale for each interpolation service
       ...
       * The returned string will be ```undefined``` if settings up $translate hasn't finished.
       * @example
