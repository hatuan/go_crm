...
define(['application-configuration', 'ajaxService'], function (app) {
    ...
    app.register.service('businessRelationTypesService', ['ajaxService', function (ajaxService) {
        ...
        this.getBusinessRelationTypesWithNoBlock = function (businessRelationType, successFunction, errorFunction) {
            ajaxService.AjaxGetWithNoBlock(businessRelationType, "/api/businessrelationtypes", successFunction, errorFunction);
        };
